...
./bin/mobilecoind-mirror-private --mirror-public-uri "mobilecoind-mirror://$PUBLIC_HOST/?ca-bundle=mirror.crt&tls-hostname=localhost" --mobilecoind-uri insecure-mobilecoind://localhost:4444/
