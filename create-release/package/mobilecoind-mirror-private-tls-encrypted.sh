...
./bin/mobilecoind-mirror-private --mirror-public-uri "mobilecoind-mirror://$PUBLIC_HOST/?ca-bundle=mirror.crt&tls-hostname=localhost" --mobilecoind-uri insecure-mobilecoind://127.0.0.1:4444/ --mirror-key mirror-private.pem
